              ...
              <li>
                ...
                <div class="dropdown-menu filters">
                  ...
                  <ul>
                    ...
                    <li><a tabindex="-1" href="#" data-placeholder="Type a organismID..." data-filter="ORGANISM_ID" title="OrganismID" data-template-filter="template-add-filter" data-template-summary="suggestions-template-filter" data-input-classes="value organism_id_autosuggest auto_add" class="filter-control">OrganismID</a></li>
                    ...
                    <li><a tabindex="-1" href="#" data-placeholder="Select a data repatriation filter..." data-filter="REPATRIATED" title="Repatriated data" data-template-filter="template-boolean-filter" data-template-summary="template-filter" class="filter-control" data-input-classes=" ">Data repatriation</a></li>

                    <li><a tabindex="-1" href="#" data-placeholder="Type a locality..." data-filter="LOCALITY" title="Locality" data-template-filter="template-add-filter" data-template-summary="suggestions-template-filter" data-input-classes="value locality_autosuggest auto_add" class="filter-control">Locality</a></li>
                    <li><a tabindex="-1" href="#" data-placeholder="Type a state or province..." data-filter="STATE_PROVINCE" title="State/Province" data-template-filter="template-add-filter" data-template-summary="suggestions-template-filter" data-input-classes="value state_province_autosuggest auto_add" class="filter-control">State/Province</a></li>
                    <li><a tabindex="-1" href="#" data-placeholder="Type a water body name..." data-filter="WATER_BODY" title="Water body" data-template-filter="template-add-filter" data-template-summary="suggestions-template-filter" data-input-classes="value water_body_autosuggest auto_add" class="filter-control">Water body</a></li>
                    <li><a tabindex="-1" href="#" data-placeholder="Type a protocol..." data-filter="PROTOCOL" title="Protocol" data-template-filter="template-protocol-filter" data-template-summary="template-filter" class="filter-control">Protocol</a></li>
                    <li><a tabindex="-1" href="#" data-placeholder="Type a license..." data-filter="LICENSE" title="License" data-template-filter="template-license-filter" data-template-summary="template-filter" class="filter-control">License</a></li>
                  </ul>
...
<@common.notice title="Limited paging">
 ...
 <#if action.showDownload() && !fullTextSearch>
