  ...
  <@common.article id="location" title=title titleRight=titleRight class="occurrenceMap">
    ...
    <div class="right">
        <div class="scrollable330">
          ...
          <@kv header="Elevation" value=occ.elevation plusMinus=occ.elevationAccuracy!?string />
          <@kv header="Depth" value=occ.depth plusMinus=occ.depthAccuracy!?string />
          <@kv header="Distance Above Surface" value=occ.distanceAboveSurface plusMinus=occ.distanceAboveSurfaceAccuracy!?string />
