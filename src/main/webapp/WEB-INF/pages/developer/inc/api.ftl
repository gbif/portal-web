...
<#if addSearchParams>
  ...
  "facetMincount": "Used in combination with the facet parameter. Set facetMincount={#} to exclude facets with a count less than {#}, e.g. <a href='${action.cfg.apiBaseUrl}/dataset/search?facet=type&limit=0&facetMincount=10000' target='_blank'>/search?facet=type&limit=0&facetMincount=10000</a> only shows the type value 'OCCURRENCE' because 'CHECKLIST' and 'METADATA' have counts less than 10000.",
  "facetMultiselect": "Used in combination with the facet parameter. Set facetMultiselect=true to still return counts for values that are not currently filtered, e.g. <a href='${action.cfg.apiBaseUrl}/dataset/search?facet=type&limit=0&type=CHECKLIST&facetMultiselect=true' target='_blank'>/search?facet=type&limit=0&type=CHECKLIST&facetMultiselect=true</a> still shows type values 'OCCURRENCE' and 'METADATA' even though type is being filtered by type=CHECKLIST"
  }+params />
<#else>
