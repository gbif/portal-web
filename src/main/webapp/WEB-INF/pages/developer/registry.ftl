...
<@api.article id="datasetSearch" title="Dataset Search">
  ...
  <@api.apiTable auth=false >
    <@trowS url="/search" respLink="dataset/search?q=plant&amp;publishingCountry=AR" paging=true params=["q","country","type","subtype","license","keyword","publishingOrg","hostingOrg","decade","publishingCountry","continent","project_id","hl","facet","facetMincount","facetMultiselect"]>Full text search across all datasets.
...
<#assign params = {
  ...
  "project_id": "Filters datasets by project identifier, this refers to the project in which this dataset was collected",
