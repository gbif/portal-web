<content tag="infoband">
    ...
    <div class="box">
        <div class="content">
            ...
            <a href="<@s.url value='http://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.1.1/ipt-2.1.1.war'/>" title="View occurrences" class="candy_blue_button" onClick="ga('send', 'event', 'IPT_war', 'Download', 'IPT_2_1_1');"><span>Download</span></a>
        </div>
    </div>
</content>
