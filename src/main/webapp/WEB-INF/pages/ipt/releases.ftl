...
<@common.article id="about" title="Latest release – version 2.0.5, 17 May 2013" titleRight="Version history">
  <div class="left">
    ...
    <p>The next version of the IPT will be released in March 2014. It will be called 2.1, and it will represent a major upgrade because it will be based on the brand-new GBIF Registry web services, developed as part of the new GBIF Data Portal. This will allow the IPT to overcome limitations of the old web services, such as only being able to register a single contact per dataset. This version will also address an <a href="https://code.google.com/p/gbif-providertoolkit/issues/detail?id=976" title="Link to IPT issue regarding temporary directory" target="_blank">issue</a> found in 2.0.5, where the IPT’s temporary directory fills up causing a disk out of space exception.</p>
