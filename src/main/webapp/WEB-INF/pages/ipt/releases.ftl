...
<@common.article id="about" title="Latest release – version 2.3.4, March 2017" titleRight="Version history">
    <div class="left">
        <p>
            This new version fixes a <a href="https://struts.apache.org/docs/s2-045.html" title="Link to security vulnerability in Struts2" target="_blank">security vulnerability</a> that was discovered in the Apache Struts web framework, which the IPT uses. This security vulnerability affects all IPT versions, including 2.3.3, therefore all users should plan to upgrade to this version immediately following the instructions in the <a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes233.wiki" title="IPT v2.3.4 Release Notes" target="_blank">Release Notes</a>.
        </p>
        <p>
            A description of the exciting new features added to the IPT in version 2.3.3 are described in <a href="http://gbif.blogspot.dk/2017/01/ipt-v233-your-repository-for.html" title="Link to blog post about v2.3.3" target="_blank">this blog post</a>.
        ...
        <p>
        <h3><a href="http://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.3.4/ipt-2.3.4.war" title="Link to download IPT v2.3.4" onClick="ga('send', 'event', 'IPT_war', 'Download', 'IPT_2_3_4');">Download</a></h3>
        <h3><a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes233.wiki" title="IPT v2.3.4 Release notes" target="_blank">Release notes (upgrade instructions)</a></h3>
        <h3><a href="http://gbif.blogspot.dk/2017/01/ipt-v233-your-repository-for.html" title="Link to blog post about v2.3.3" target="_blank">v2.3.3 Blog Post</a></h3>
        </p>
        <p>&nbsp;</p>
        ...
        <p>
            ...
            <a href="https://github.com/gbif/ipt/issues"
               ...
               target="_blank">70 open issues</a>. Weigh in on existing issues with a "thumbs-up", or submit a new feature request for functionality you would like to see implemented.
        </p>
    </div>
    <div class="right">
        <h3><strong>2.3.4</strong> - March, 2017</h3>
        <ul>
            <li><a href="http://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.3.4/ipt-2.3.4.war" title="Dowload IPT v2.3.4" onClick="ga('send', 'event', 'IPT_war', 'Download', 'IPT_2_3_4');">Download</a> / <a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes233.wiki" title="IPT v2.3.4 Release Notes" target="_blank">Notes</a></li>
            ...
            <li>Addressed <a href="https://github.com/gbif/ipt/projects/3" title="IPT v2.3.4 Issues List" target="_blank">6 issues</a>: 3 Defects, 2 Enhancements and 1 Other
            </li>
            <li>Translated into 7 languages</li>
        </ul>
        <h3><strong>2.3.3</strong> - December, 2016</h3>
        <ul>
            <li><strike>Download</strike> / <a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes233.wiki" title="IPT v2.3.3 Release Notes" target="_blank">Notes</a></li>
            <li><a href="https://github.com/gbif/ipt/wiki/IPT2ManualNotes.wiki" title="IPT User Manual" target="_blank">User Manual</a> <a href="https://github.com/gbif/ipt/wiki/IPT2ManualNotes_ES.wiki" title="IPT User Manual Spanish" target="_blank">(es)</a></li>
        ...
        <ul>
            <li><strike>Download</strike> / <a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes23.wiki" title="IPT v2.3 Release Notes" target="_blank">Notes</a></li>
        ...
        <ul>
            <li><strike>Download</strike> / <a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes22.wiki" title="IPT v2.2 Release Notes" target="_blank">Notes</a></li>
        ...
        <ul>
            <li><strike>Download</strike> / <a href="https://github.com/gbif/ipt/wiki/IPTReleaseNotes21.wiki" title="IPT v2.1 Release Notes" target="_blank">Notes</a></li>
